...
@section('one')
    <div>
        ...
        @endif
        <form action="{{ url('modifieraut/' . $auteurs->id) }}" method="post">
            @csrf
            @method('PATCH')
            <table class="flex justify-center bg-gray-100 py-10 rounded-md mb-2">
                <tr>
                    <td class="">nom : </td>
                    <td>
                        <input name="nom"  value="{{ $auteurs->nom }}" type="text"  class="border p-2 w-96 ml-10 rounded-md ">
                    </td>
                </tr>
                <tr>
                    <td class="">prenom :</td>
                    <td>
                        <input name="prenom" value="{{ $auteurs->prenom }}" type="text"  class="border p-2 w-96 ml-10 rounded-md">
                    </td>
                </tr>
            </table>
